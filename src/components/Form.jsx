    ...
    <form className="form" onSubmit={handleSubmit} autoComplete="on">
      <div className="form_group">
        <input
          ...
          onBlur={handleBlur}
          className={errors.name ? 'input-error form_input' : 'form_input'}
        ></input>
        <label className="form_label">Enter your name</label>
        <div className="input_error" id="error_name">
      ...
      <div className="form_group">
        ...
        ></input>
        <label className="form_label">Enter email*</label>
        <div className="input_error" id="error_email">
      ...
      <Button
        className="button--accent-color form_button"
        type="submit"
